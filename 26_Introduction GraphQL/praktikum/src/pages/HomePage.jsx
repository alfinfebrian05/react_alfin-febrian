...
const HomePage = () => {
  ...
  const RETRIEVE_PRODUCT_BY_ID_QUERY = gql`
    query QUERY_PRODUCT_BY_ID($id: Int!) {
  ...
  const {
    loading: loadingQueryByIdroduct,
    error: errorQueryByIdProduct,
    data: dataQueryByIdProduct,
  } = useQuery(RETRIEVE_PRODUCT_BY_ID_QUERY);
      ...
      <Container className="py-3 py-md-5">
        ...
        <Row className="g-sm-4 gap-4 row-gap-3 row-gap-md-0 gap-md-0 gap-lg-0">
          ...
          {dataProduct?.products.length === 0 ? (
            ...
            dataProduct?.products.map((product, idx) => (
